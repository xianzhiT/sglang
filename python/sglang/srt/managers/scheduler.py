...
class Scheduler(
    ...
    def init_weights_send_group_for_remote_instance(
        ...
        if recv_req.is_draft_model:
            success, message = self.draft_worker.init_weights_send_group_for_remote_instance(
                recv_req
            )
        else:
    ...
    def send_weights_to_remote_instance(
        ...
        if recv_req.is_draft_model:
            success, message = self.draft_worker.send_weights_to_remote_instance(recv_req)
        else:
